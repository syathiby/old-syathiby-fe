    ...
    const handleRemove = async (id) => {
        try {
          ...
          if (result.isConfirmed) {
            await remove(`v1/admin/kategori/${id}`);
            Swal.fire({
                title: 'Deleted!',
                    ...
                    {apiData.map((item, index) => {
                        return (
                            <tr key={index}>
                                ...
                                <td className="px-4 py-2 text-gray-700 whitespace-nowrap">{item.nkategori}</td>
