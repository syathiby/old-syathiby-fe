                ...
                <div className="flex items-start max-w-6xl mx-auto mt-16">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col items-center justify-center mt-8">
                            <img loading="lazy" className="object-cover rounded-full w-14 h-14" src="https://images.unsplash.com/photo-1499470932971-a90681ce8530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
